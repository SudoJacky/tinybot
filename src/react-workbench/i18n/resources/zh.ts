...
export const zh = {
  common: {
    ...
    graphs: {
      ...
      runTitle: "运行 Graph", runDescription: "运行已保存的线性 Agent 路径。暂不支持条件和分支。", runInput: "输入",
      runInputPlaceholder: "描述需要这个 Graph 完成的工作…", run: "运行", running: "运行中…", saveBeforeRun: "请先保存 Graph 更改。",
      ...
      nodeContentUnavailable: "这条旧运行记录没有保存最初输入。", nodeOutputUnavailable: "这次运行还没有产生 Graph 输出。",
