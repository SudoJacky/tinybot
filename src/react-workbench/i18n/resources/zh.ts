...
export const zh = {
  ...
  settings: {
    ...
    hooks: {
      ...
      description: "在 UserPromptSubmit、PreToolUse、PostToolUse 和 PostCompact 阶段运行可信命令。定义的精确哈希未被信任前不会执行。",
      workspace: "工作区目录", workspacePlaceholder: "使用 Tinybot 已配置的工作区", reload: "加载 Hooks", loading: "正在加载 Hook 定义…",
      configHint: "请直接编辑 hooks.json，然后重新加载；任何变更都会产生新哈希，必须重新审查并信任。",
      ...
      managed: {
        ...
        scripts: "Hook 脚本", chooseScript: "选择要编辑的脚本", noScripts: "该工作区没有托管 Hook 脚本",
        loadingScript: "正在加载脚本…", editScript: "编辑脚本", scriptEditorTitle: "编辑 {{name}}",
        scriptContents: "脚本内容", scriptEditorHint: "Tinybot 只会保存这个托管脚本；若文件已在外部修改，请重新加载后再保存。",
