  ...
  common: {
    ...
    tools: {
      ...
      mcpForm: {
        ...
        description: "将 Streamable HTTP Server 添加到 Tinybot 的全局配置。",
        name: "名称", namePlaceholder: "MCP Server 名称", type: "类型", streamableHttp: "Streamable HTTP", url: "URL",
        ...
        errors: {
          ...
          urlInvalid: "请输入不包含凭据和片段的 HTTP 或 HTTPS URL。", envVarInvalid: "请输入有效的环境变量名。",
