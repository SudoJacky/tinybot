...
export const zh = {
  common: {
    ...
    graphs: {
      ...
      canvasHint: "拖动节点调整位置；拖动画布可平移，Ctrl + 滚轮可缩放，Delete 可删除所选项。",
      canvasViewHint: "选择节点查看详情；拖动画布可平移，Ctrl + 滚轮可缩放。",
      canvasControls: "画布视图控制", zoomOut: "缩小", zoomIn: "放大", resetCanvasView: "复位画布视图",
      zoomOutShortcut: "缩小（Ctrl/Cmd -）", zoomInShortcut: "放大（Ctrl/Cmd +）", resetCanvasViewShortcut: "复位画布视图（Ctrl/Cmd 0）",
