export const en = {
  ...
  settings: {
    ...
    hooks: {
      eyebrow: "Automation",
      title: "Hooks",
      description: "Run trusted commands at UserPromptSubmit, PreToolUse, PostToolUse, and PostCompact. Definitions are disabled until their exact hash is trusted.",
      workspace: "Workspace directory",
      workspacePlaceholder: "Use the configured Tinybot workspace",
      reload: "Load hooks",
      loading: "Loading hook definitions…",
      configHint: "Edit hooks.json directly, then reload and review each changed definition before trusting it.",
      ...
      managed: {
        ...
        scriptEditorHint: "Tinybot saves only this managed script. If it changed outside Tinybot, reload before saving.",
