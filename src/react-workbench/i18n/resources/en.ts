export const en = {
  common: {
    ...
    graphs: {
      ...
      runTitle: "Run Graph",
      runDescription: "Run a saved linear Agent path. Conditions and branches are not supported yet.",
      runInput: "Input",
      runInputPlaceholder: "Describe the work for this Graph…",
      run: "Run",
      running: "Running…",
      ...
      nodeContentUnavailable: "This older Run does not contain the original input.",
      ...
      editErrors: {
        ...
        node_not_configurable: "Only Agent nodes have execution settings.",
