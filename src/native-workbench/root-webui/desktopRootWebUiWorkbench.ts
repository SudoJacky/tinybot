...
} from "../shell/desktopWorkbenchLayout";
import { renderDesktopAppSidebar } from "../shell/desktopAppSidebar";
import {
  applyRootWebUiShellLayout,
  ensureDesktopRootWebUiShellLayoutStyle,
} from "../shell/desktopShellLayout";
import {
  ensureDesktopComposerSurfaceStyle,
  installRootWebUiComposerRuntime,
} from "../chat/desktopComposerSurface";
...
import { installDesktopDesignTokens } from "../shell/desktopDesignTokens";
