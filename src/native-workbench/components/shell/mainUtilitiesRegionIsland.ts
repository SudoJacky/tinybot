...
import type { DesktopToolsSkillsPaneModel } from "../../tools-skills/desktopToolsSkills";
...
import { mountAgentUiFormsSurfaceIsland } from "../agent-ui/agentUiFormsSurfaceIsland";
import { mountCommandPaletteIsland } from "../shared/commandPaletteIsland";
import {
  mountCoworkPaneIsland,
  type CoworkPaneGraphSelection,
} from "../cowork/coworkPaneIsland";
import { mountFileActionsSurfaceIsland } from "../workspace/fileActionsSurfaceIsland";
import {
...
} from "../knowledge/knowledgePaneIsland";
import { mountSettingsPaneIsland } from "../settings/settingsPaneIsland";
import {
  mountToolsSkillsPaneIsland,
  type ToolsSkillsPaneActionEvent,
} from "../tools-skills/toolsSkillsPaneIsland";
import { desktopNaiveThemeOverrides } from "./desktopNaiveTheme";
import { mountWorkspaceFilesSurfaceIsland } from "../workspace/workspaceFilesSurfaceIsland";
