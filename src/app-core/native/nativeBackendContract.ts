export const NATIVE_BACKEND_COMMAND_NAMES = [
  ...
  "worker_automations_list",
  "worker_automation_save",
  "worker_automation_delete",
  "worker_automation_run",
  "worker_automation_output",
  ...
  "worker_workspace_register",
  "worker_workspace_rename",
  "worker_workspace_forget",
