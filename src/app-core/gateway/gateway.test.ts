...
describe("gateway WebSocket client", () => {
  test("creates outbound chat control messages", () => {
    ...
    expect(createGatewaySocketMessage.command("chat-1", {
      ...
      target: { turnId: "run-1", sessionId: "websocket:chat-1" },
    ...
    expect(createGatewaySocketMessage.command("chat-1", {
      ...
      turn_id: "run-request-1",
      session_id: "websocket:chat-1",
      source: { control: "files-explain-selection", surface: "tinyos" },
      instruction: "Explain this selection.",
      observed_turn_id: "run-completed-1",
      references: [{
        detail: "TinyOS file selection",
        kind: "reference",
        sourceEndLine: 3,
    ...
    expect(createGatewaySocketMessage.command("chat-1", {
      ...
      turn_id: "tinyos-host-terminal-1",
      session_id: "websocket:chat-1",
      source: { control: "terminal-command", surface: "tinyos" },
      command: "npm test",
      confirmed: true,
