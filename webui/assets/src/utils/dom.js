export const elements = {
  ...
  coworkComposerKicker: document.querySelector("#cowork-composer-kicker"),
  coworkComposerLabel: document.querySelector("#cowork-composer-label"),
  coworkModeTabs: document.querySelector("#cowork-mode-tabs"),
  coworkModeLabel: document.querySelector("#cowork-mode-label"),
  coworkGoalInput: document.querySelector("#cowork-goal-input"),
  coworkWorkflowMode: document.querySelector("#cowork-workflow-mode"),
  ...
  coworkBranchList: document.querySelector("#cowork-branch-list"),
  coworkFocusStrip: document.querySelector("#cowork-focus-strip"),
  coworkFocusProgress: document.querySelector("#cowork-focus-progress"),
  coworkFocusProgressDetail: document.querySelector("#cowork-focus-progress-detail"),
  coworkFocusRunning: document.querySelector("#cowork-focus-running"),
  coworkFocusRunningDetail: document.querySelector("#cowork-focus-running-detail"),
  coworkFocusNext: document.querySelector("#cowork-focus-next"),
  coworkFocusNextDetail: document.querySelector("#cowork-focus-next-detail"),
  coworkFocusOutput: document.querySelector("#cowork-focus-output"),
  coworkFocusOutputDetail: document.querySelector("#cowork-focus-output-detail"),
  coworkInsightPanel: document.querySelector("#cowork-insight-panel"),
  coworkInsightMode: document.querySelector("#cowork-insight-mode"),
  coworkInsightFocus: document.querySelector("#cowork-insight-focus"),
  ...
  coworkArtifactPanel: document.querySelector("#cowork-artifact-panel"),
  coworkWorkspaceDir: document.querySelector("#cowork-workspace-dir"),
  ...
  coworkArchitectureProjectionSummary: document.querySelector("#cowork-architecture-projection-summary"),
  coworkArchitectureProjectionList: document.querySelector("#cowork-architecture-projection-list"),
  ...
  coworkWorkUnitSummary: document.querySelector("#cowork-work-unit-summary"),
  coworkWorkUnitList: document.querySelector("#cowork-work-unit-list"),
  coworkDagSummary: document.querySelector("#cowork-dag-summary"),
  coworkTaskDagList: document.querySelector("#cowork-task-dag-list"),
  coworkAgentSummary: document.querySelector("#cowork-agent-summary"),
  coworkTraceFilter: document.querySelector("#cowork-trace-filter"),
  coworkTraceModeTabs: document.querySelector("#cowork-trace-mode-tabs"),
  coworkTraceList: document.querySelector("#cowork-trace-list"),
  coworkSecondaryTabs: document.querySelector("#cowork-secondary-tabs"),
  coworkGraphCollapseButton: document.querySelector("#cowork-graph-collapse-button"),
  coworkMapButton: document.querySelector("#cowork-map-button"),
  coworkTraceCollapseButton: document.querySelector("#cowork-trace-collapse-button"),
  coworkGraphRailButton: document.querySelector("#cowork-graph-rail-button"),
  coworkTraceRailButton: document.querySelector("#cowork-trace-rail-button"),
  coworkConversationPanel: document.querySelector("#cowork-conversation-panel"),
  coworkArtifactSummary: document.querySelector("#cowork-artifact-summary"),
  coworkObservableArtifactList: document.querySelector("#cowork-observable-artifact-list"),
  coworkBranchResultSummary: document.querySelector("#cowork-branch-result-summary"),
  coworkBranchResultList: document.querySelector("#cowork-branch-result-list"),
  coworkBranchMergeButton: document.querySelector("#cowork-branch-merge-button"),
  coworkInspectorKind: document.querySelector("#cowork-inspector-kind"),
  coworkSelectedInspector: document.querySelector("#cowork-selected-inspector"),
  coworkTaskAssignButton: document.querySelector("#cowork-task-assign-button"),
  coworkTaskRetryButton: document.querySelector("#cowork-task-retry-button"),
  coworkTaskReviewButton: document.querySelector("#cowork-task-review-button"),
  ...
  coworkBlueprintInput: document.querySelector("#cowork-blueprint-input"),
  coworkBlueprintValidateButton: document.querySelector("#cowork-blueprint-validate-button"),
  coworkBlueprintPreviewButton: document.querySelector("#cowork-blueprint-preview-button"),
  coworkBlueprintStatus: document.querySelector("#cowork-blueprint-status"),
  coworkBlockerSummary: document.querySelector("#cowork-blocker-summary"),
  coworkBlockerPanel: document.querySelector("#cowork-blocker-panel"),
  coworkEvaluationSummary: document.querySelector("#cowork-evaluation-summary"),
  coworkEvaluationList: document.querySelector("#cowork-evaluation-list"),
  ...
  coworkFieldOverlay: document.querySelector("#cowork-field-overlay"),
