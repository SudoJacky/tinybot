...
pub enum AgentTurnItemData {
    ...
    PlanProgress {
        ...
        steps: Vec<crate::worker_agent_runtime::AgentPlanStep>,
        summary: String,
        completed: u32,
        total: u32,
