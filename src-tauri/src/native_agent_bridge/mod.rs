...
pub(crate) use result_projection::{
    ...
    native_agent_model, native_agent_provider, native_agent_run_completed_at, native_agent_run_id,
    native_agent_run_phase_from_stop_reason, native_agent_run_status, native_agent_session_id,
    native_agent_string_field, native_agent_token_usage_info, native_agent_usage,
};
...
#[cfg(test)]
pub(crate) use trace_sink::NativeAgentRunSemanticSink;
