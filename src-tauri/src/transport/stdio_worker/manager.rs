...
mod tests {
    ...
    #[test]
    fn manager_runs_worker_fixture_agent_echo() {
        let events = Arc::new(Mutex::new(Vec::new()));
        let event_log = events.clone();
        let fixture = WorkspaceFixture::new();
        fixture.write("AGENTS.md", "agents");
        ...
        manager
            .start_stdio_rpc(stdio_worker_fixture_spec(), router)
            .expect("worker fixture should start");
        ...
        let result = response
            .result
            .expect("worker fixture should return result");
    ...
    #[test]
    fn manager_runs_worker_fixture_agent_event_flow() {
        let events = Arc::new(Mutex::new(Vec::new()));
        let event_log = events.clone();
        let fixture = WorkspaceFixture::new();
        fixture.write("AGENTS.md", "agents");
        ...
        let request = WorkerRequest::new(
            "agent-req-native-flow-1",
            "trace-native-agent-flow",
            "agent.fixture_flow",
    ...
    fn stdio_worker_fixture_spec() -> WorkerCommandSpec {
