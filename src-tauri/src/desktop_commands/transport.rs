use crate::agent_loop_runtime_protocol::{AgentRuntimeEventAppender, AgentRuntimeEventEnvelope};
...
use crate::native_agent_bridge::{
    ...
    pending_approvals_from_checkpoint, persist_native_agent_run_start,
