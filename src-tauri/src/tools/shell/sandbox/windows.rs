...
pub(in crate::tools::shell) struct WindowsReadOnlySpawn {
    pub(in crate::tools::shell) process_id: u32,
    pub(in crate::tools::shell) stdin: File,
    pub(in crate::tools::shell) stdout: File,
    pub(in crate::tools::shell) stderr: File,
    pub(in crate::tools::shell) child: WindowsReadOnlyChild,
}

pub(in crate::tools::shell) struct WindowsReadOnlyChild {
    process: OwnedHandle,
...
impl WindowsReadOnlyChild {
    pub(in crate::tools::shell) fn try_wait(&mut self) -> io::Result<Option<i32>> {
    ...
    pub(in crate::tools::shell) fn terminate(&mut self) -> io::Result<()> {
...
pub(in crate::tools::shell) fn spawn_read_only_pipe_process(
    command: &str,
    working_dir: &Path,
