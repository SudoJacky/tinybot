"""OpenAI-compatible HTTP API server for a fixed tinybot session.
...
async def handle_chat_completions(request: web.Request) -> web.Response:
    ...
    model_name: str = request.app.get("model_name", "tinybot")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "tinybot")
    return web.json_response({
        "object": "list",
        "data": [
            {
