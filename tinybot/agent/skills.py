...
class SkillsLoader:
    ...
    def _parse_tinybot_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (supports tinybot and openclaw keys)."""
        try:
            data = json.loads(raw)
            return data.get("tinybot", data.get("openclaw", {})) if isinstance(data, dict) else {}
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get tinybot metadata for a skill (cached in frontmatter)."""
