"""JSON Schema fragment types: all subclass :class:`~tinybot.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~tinybot.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~tinybot.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~tinybot.agent.tools.base.Schema`.
...
from tinybot.agent.tools.base import Schema
