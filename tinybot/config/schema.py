...
class ChannelsConfig(Base):
    ...
    def is_enabled(self, name: str) -> bool:
        """Check whether a channel is enabled by name."""
...
class ToolsConfig(Base):
    ...
    restrict_to_workspace: bool = True  # Restrict tool access to workspace directory by default
...
class Config(BaseSettings):
    ...
    def get_provider_name(self, model: str | None = None) -> str | None:
        """Get the registry name of the matched provider (e.g. "deepseek", "openai")."""
